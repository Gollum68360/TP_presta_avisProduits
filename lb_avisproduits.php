...
class Lb_avisProduits extends Module
{
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit("submit_lb_avisproduits")) { //vérifie si formulaire envoyé avec la name de mon bouton
